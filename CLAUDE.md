...
| Adaptive Scope           | `.context/app/questionnaire/adaptive-scope.md`                | Which parts of a questionnaire apply to this respondent — topics, hard rules, the Scope Planner, the Routing Analyst, report/scoring awareness, respondent amendment               |
...
| Question Fidelity        | `.context/app/questionnaire/question-fidelity.md`             | Per-question "ask as written ↔ fill creatively" dial — the five stops, the two no-op layers, why it never overrides Adaptive Scope, the fork/export carriage chain                 |
