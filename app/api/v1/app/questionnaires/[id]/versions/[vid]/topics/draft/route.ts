 ...
 *   the hard rules, optionally applies the breadth limit the document stated, and clears the draft
 *   — in one transaction. Forks a new draft first if the target is launched.
 *
