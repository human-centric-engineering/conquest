...
> guardrails G03 and G05 from that workbook's Guardrails tab. `scripts/author/workbook-questionnaire.ts`
...
`scripts/author/workbook-questionnaire.ts` prints "do not build a composite across Section 14 and
