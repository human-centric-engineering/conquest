...
| Lead          | Simon Holmes                                                                                                                                                                                                                                                                                                       |
| Status        | `building` — P0 done (F0.1, PR #10); P1 done (F1.1 ingestion: PR #13/#14/#15); P2.5 done (F2.5.1, #21); P2 done (F2.1 #18/#19, F2.2 #23, F2.3 #24, F2.4 #25); P3 done (F3.1 #26, F3.2 #27, F3.3 #28, F3.4 #29); P4 in flight (F4.1 #30, F4.2 #32 merged; F4.3 contradiction detection in flight; F4.4–F4.6 remain) |
| Opened        | 2026-05-30                                                                                                                                                                                                                                                                                                         |
...
| **P4**   | Conversational engine (non-streaming)           | in flight   | Selection · extraction · contradiction · completion logic, exercised without the streaming surface. F4.1 selection strategies (#30) + F4.2 answer extraction (#32) merged; F4.3 contradiction detection in flight; F4.4–F4.6 remain.                                                                                 |
