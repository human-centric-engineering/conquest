...
| Lead          | Simon Holmes                                                                                                                                                           |
| Status        | `building` — P0 done (F0.1, PR #10); P1 done (F1.1 ingestion: PR #13/#14/#15); P2 in flight (F2.1 PR1 read surface + admin shell done on `feat/f2.1-pr1-read-surface`) |
| Opened        | 2026-05-30                                                                                                                                                             |
...
| **P2**   | Admin CRUD over questionnaires                  | in flight   | Admin UI: list, edit, version, tag, review extraction changes. F2.1 PR1 (read surface + admin shell) done; F2.1 PR2 + F2.2–F2.4 remain.                                                                                                               |
...
_Status:_ in flight — PR1 (read surface + admin shell) done on `feat/f2.1-pr1-read-surface`; PR2 (structural authoring + version-fork) not started · _Size:_ multi-PR (2 PRs) · _Owner:_ TBD · _Deps:_ F1.1
