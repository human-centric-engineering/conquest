...
| Lead          | Simon Holmes                                                                                                                                                                        |
| Status        | `building` — P0 done (F0.1, PR #10); P1 in progress (F1.1 schema + core in PR #13; extractor capability in PR #14; ingestion route + persistence in PR #15 — F1.1 feature-complete) |
| Opened        | 2026-05-30                                                                                                                                                                          |
...
| **P1**   | Questionnaire ingestion                         | in progress | Admin uploads a doc; LLM extracts structure; changes recorded for review. API-only. F1.1 PR1 (schema) + PR2 (pure core) in PR #13; PR3 (extractor capability) in PR #14; PR4 (ingestion route + persistence) in PR #15 — F1.1 feature-complete. |
