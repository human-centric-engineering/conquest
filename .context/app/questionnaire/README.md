...
| [`design-evaluation.md`](./design-evaluation.md)             | Seven LLM judges score a version's structure vs goal/audience + propose edits — pure core, capability, preview route (F5.1) |
