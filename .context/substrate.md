...
| **Errors**         | `errors/`        | Error handling, boundaries, Sentry                |
| **Logging**        | `logging/`       | Structured logging, request context, patterns     |
...
| **Orchestration**  | `orchestration/` | Agent orchestration, LLM providers, cost tracking |
