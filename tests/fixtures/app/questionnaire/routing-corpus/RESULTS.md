...
| T14 | R010, R011             | 10             | open                                              | Doc 10 says _"a partner takes one of these, not several"_ — a mutual-exclusivity constraint the schema cannot express, which the README puts in `gaps[]`. R010 run 1 missed it, run 2 gapped it, R011 quoted the sentence inside all three role topics' `sourceQuote`s and never mentioned it. Two of three runs silent. It is the only inexpressible thing on this document that is still undeclared now the stop conditions are gapped, and it is what holds `R` at 1.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
