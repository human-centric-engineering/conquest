...
describe('POST /api/v1/app/questionnaires — conditional topics candidacy wiring', () => {
  it('includes conditionalTopicsCandidate in the 201 body when the check resolves a verdict', async () => {
  ...
  it('calls the candidacy check with the persisted versionId and the parsed document text', async () => {
    ...
    expect(checkConditionalTopicsCandidacy).toHaveBeenCalledWith(
      expect.objectContaining({
