 ...
 *
 * The resolver, rate limiter, and token minter are mocked. Pins the public surface: the live-sessions
 * flag gate, the tight IP sub-cap (throttling ref enumeration), the generic 404 on any non-match (no
