...
const prismaMock = vi.hoisted(() => ({
  ...
  // Adaptive Scope (P17): `replaceDataSlots` now attaches the slots it just wrote to the version's
...
beforeEach(() => {
  ...
  // Adaptive Scope, which makes the attach pass inside `replaceDataSlots` a no-op for every test
...
/**
 * Adaptive Scope (P17): saving data slots gives them a home among the version's topics.
 *
