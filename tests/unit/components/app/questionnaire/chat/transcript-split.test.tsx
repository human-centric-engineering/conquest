...
function streamStub(turns: QuestionnaireTurn[]): UseQuestionnaireSessionStreamReturn {
  return {
    turns,
    streaming: false,
    inspectorTurns: [],
